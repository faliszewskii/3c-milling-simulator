...
vec4 descendingAlgorithm(float t, int n)
{
    ...
    if(n == 2) return vec4(N2_1, N20, N21, 0);
...
//    float h = 0.001f;
//
//    vec3 p1 = deCasteljau2D(coefficients, u, v);
//    vec3 p2 = deCasteljau2D(coefficients, u + h, v);
//
//    return (p2 - p1) / h;
//}
//
...
//
//    vec3 p1 = deCasteljau2D(coefficients, u, v);
//    vec3 p2 = deCasteljau2D(coefficients, u, v + h);
//
//    return (p2 - p1) / h;
//}
